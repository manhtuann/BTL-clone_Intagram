...
function Navbar() {
    const items = [
        {
            img: <svg aria-label="Home" class="_ab6-" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24"><path d="M9.005 16.545a2.997 2.997 0 012.997-2.997h0A2.997 2.997 0 0115 16.545V22h7V11.543L12 2 2 11.543V22h7.005z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg>
        },
        {
            ...
            <nav className='nav'>
                <div className="nav-wrap">
                    <div className="nav-logo">
                        <img className='img-logo' src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Instagram_logo.svg/2560px-Instagram_logo.svg.png" alt="" />
                    </div>
                    ...
                    <div className="nav-list-items">
                        <ul className='items'>
                            {items.map((item, index) => (
                                <li key={index} className='item'>{item.img}</li>
                            ))}
                            <li className='items' onClick={handleTogger}>
                                <img alt="p.m.t.10.03's profile picture" class="_aa8j" crossorigin="anonymous" draggable="false" src="https://images.unsplash.com/photo-1644982652061-df82282e178d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80">
                                </img>
                            </li>
                        </ul>
                    </div>
                    <div className={togger ? 'nav-lv2' : 'nav-lv2 active'}>
                        <ul className="nav-list-lv2">
                            <li className="item-lv2">Profile</li>
