...
function Navbar() {
    const items = [
        ...
        {
            img:<img alt="p.m.t.10.03's profile picture" class="_aa8j" crossorigin="anonymous" draggable="false" src="https://images.unsplash.com/photo-1644982652061-df82282e178d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"></img>
        }
    ]
    return (
        <>
